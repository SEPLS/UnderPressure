...
public class ConfiguredFeaturesInit {
    ...
    private static final Supplier<List<OreConfiguration.TargetBlockState>> TIN_ORE_OVERWORLD_REPLACEMENT = Suppliers.memoize(() ->
    ...
    public static final RegistryObject<ConfiguredFeature<?,?>> TIN_ORE = CONFIGURED_FEATURES.register("tin_ore" ,
            () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(TIN_ORE_OVERWORLD_REPLACEMENT.get(), 11)));
